...
{
    public static class csConnectionMLB
    {
        ...
        private static string ConnectionString()
        {
            try
            {
                return ConfigurationManager.ConnectionStrings["MLB"].ConnectionString;
            }
            catch (Exception ex)
            {
        ...
        public static Boolean ExecutePAConfirmation(String namePA, Hashtable parameters)
        {
            //SqlConnection sqlCon = new SqlConnection(ConnectionString());
            DataSet ds = new DataSet();
            Boolean retorno;
