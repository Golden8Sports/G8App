<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BusinessR.aspx.cs" MasterPageFile="~/Views/menu.Master" Inherits="G8_App.Views.BusinessR" %>
   ...
   <div class="row" id="hola" runat="server">
    <div class="col-xs-12">
       <ul class="nav nav-tabs nav-justified">
        <li class="nav-item active"><a data-toggle="tab" href="#menu1">OverAll</a></li>
                           ...
                           <table class="table tables"  style="width:100%;">
                                  ...
                                  <asp:Repeater runat="server" ID="rptTopPlayers">
                                      <ItemTemplate>
                                          <tr>
                                            <td ><%# Eval("AGENT") %></td>
                                            <td ><button class="btn btn-info" data-toggle="modal" data-target="#myModal"><%# Eval("PLAYER") %></button></td>
                                            <td ><%# Eval("RISK") %></td>
                                            <td ><%# Eval("NET") %></td>
                                            <td ><%# Eval("HOLD") %></td>
                                            <td ><%# Eval("BETS") %></td>
